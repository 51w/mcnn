...
int main(int argc, char** argv)
{
	...
	//yolov3.ncnn_param("googlenet.param");
	//yolov3.NcnnParam("V10000.param");
    ...
    // {
       ...
       // return -1;
    // }
	int _classN = yolov3._Nclass;
	int _thresh = yolov3._Nthresh;
	
	cv::namedWindow("result", 0);
	
cv::VideoCapture cam(argv[1]);
cv::Mat img; cv::Mat src_img;
...
if (img.empty()) break;
	...
	//shared_ptr<NNET::Blob> data = yolov3.blob_by_name("data");
	...
	//shared_ptr<NNET::Blob> prob1 = yolov3.blob_by_name("prob1");
	//shared_ptr<NNET::Blob> prob2 = yolov3.blob_by_name("prob2");
	NNET::Blob* prob1 = yolov3.net_output_blobs_[0];
	NNET::Blob* prob2 = yolov3.net_output_blobs_[1];
