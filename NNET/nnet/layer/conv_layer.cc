#include "nnet/layer/conv_layer.h"
#include "cblas.h"

namespace NNET
{

void ConvolutionLayer::SetUp(const vector<Blob*>& bottom, const vector<Blob*>& top) 
{
...
void ConvolutionLayer::Run(const vector<Blob*>& bottom, const vector<Blob*>& top)
{
