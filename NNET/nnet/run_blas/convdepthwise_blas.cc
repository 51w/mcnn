#include "convdepthwise.h"
#include "cblas.h"

namespace NNET
{

void ConvolutionDepthWise::SetUp(Tensor& Input, Tensor& Output) 
{
...
void ConvolutionDepthWise::Reshape(Tensor& Input, Tensor& Output)
{
...
void ConvolutionDepthWise::Run(Tensor& Input, Tensor& Output)
{
