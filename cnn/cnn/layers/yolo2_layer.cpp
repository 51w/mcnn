#include "cnn/layers/yolo2_layer.hpp"
#include <cmath>
#include <cfloat>
#include "cnn/nbox.h"
...
void Yolo2Layer::LayerSetUp(const vector<Blob*>& bottom, const vector<Blob*>& top) 
{
...
void Yolo2Layer::Forward_cpu(const vector<Blob*>& bottom, const vector<Blob*>& top)
{
	fprintf(stderr, "Yolo2: %f %d %d %d\n", _thresh, _classes, _num, _coords);
