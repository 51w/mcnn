...
if (img.empty()) break;
	...
	//shared_ptr<NV1::Blob> data = yolov3.blob_by_name("data");
	...
	//shared_ptr<NV1::Blob> prob1 = yolov3.blob_by_name("prob1");
	//shared_ptr<NV1::Blob> prob2 = yolov3.blob_by_name("prob2");
	NV1::Blob* prob1 = yolov3.net_output_blobs_[0];
	NV1::Blob* prob2 = yolov3.net_output_blobs_[1];
